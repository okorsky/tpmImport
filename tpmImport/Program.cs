...
namespace tpmImport
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            X509Certificate2 cert = new X509Certificate2(sPFXPath, sPassword, X509KeyStorageFlags.Exportable | X509KeyStorageFlags.UserKeySet);
            ...
            CngKey key = CngKey.Create(CngAlgorithm.Rsa, $"TPM-Import-Key-1-{cert.Thumbprint}", keyParams);
